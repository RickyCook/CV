...
- styled-components allows for easy print styling (things like links having different text in print to ensure that URLs can be followed without a click), and [theming](./src/theme.ts)
...
- If a `contacts.ts` file is found, this is used to fill out phone/email on compilation. This is not pushed, to protect privacy
